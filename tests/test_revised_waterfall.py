...
class RevisedWaterfallTests(unittest.TestCase):
    ...
    def test_legacy_cyclic_stabilizer_balance_moves_into_pillow(self):
        settings = self.settings("cyclic")
        ...
        self.assertEqual(state.pillow_stabilizer, Decimal("0"))
        self.assertEqual(state.pillow_force_majeure, Decimal("340"))
