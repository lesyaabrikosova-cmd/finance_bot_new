...
async def taxes_help(callback: CallbackQuery):
    ...
    await callback.message.answer(
        ...
        "На них копим заранее в течение года. "
        f"Сейчас, в {current_year} году, готовим деньги на налоги за {tax_year} год.\n\n"
        "<b>1 ноября</b> я напомню проверить уведомление ФНС. Нажмите "
        "«<b>Получено уведомление</b>» и введите точную сумму — Аллокатор пересчитает, "
        "сколько нужно собрать к <b>1 декабря</b>.\n\n"
        "После оплаты начнём копить на следующий год. Теперь у нас уже будет реальная "
        "сумма налога, поэтому разделим её на 12 и будем спокойно откладывать каждый месяц.\n\n"
        "<b>➤ НАЛОГ С ДОХОДА — НПД, УСН</b>\n\n"
        "Здесь всё проще: налог откладывается с каждого облагаемого поступления по вашей ставке.\n\n"
